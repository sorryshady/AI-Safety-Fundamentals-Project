...
params = Params(
    ...
    state_size=None,
    proba_frozen=0.9,
    savefig_folder=Path("shaped_plots"),
)
...
class Qlearning:
    ...
    def adjust_reward(self, reward, done):
        """
        ...
        if done and reward == 1:
            ...
            return -5  # Punishment for falling into a hole
        else:
            return -0.05  # Reward for taking a step
    ...
    for run in range(params.n_runs):
        ...
        for episode in tqdm(
            ...
            while not done:
                ...
                adjusted_reward = learner.adjust_reward(reward, done)
